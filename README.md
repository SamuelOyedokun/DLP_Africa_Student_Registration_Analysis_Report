...
- Demonstrate Excel data analysis skills end to end
...
- Data validation and formula protection
- Chart creation and data storytelling
...
**Samuel Oyedokun**
Data Analysis | Microsoft Excel | Data Storytelling
